...
function formatObjectNode(node, indent, currentIndent) {
...
function formatArrayNode(node, indent, currentIndent) {
  const indentStr = " ".repeat(currentIndent);
  const childIndent = " ".repeat(currentIndent + indent);
...
function formatWithTree(data, indent) {
